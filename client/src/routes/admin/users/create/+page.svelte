...
<svelte:head>
    <title>Administration – Créer un utilisateur</title>
    <meta 
        name="description" 
        content="Page d’administration permettant d’ajouter un nouvel utilisateur : nom, email, mot de passe et statut du compte."
    />
</svelte:head>
