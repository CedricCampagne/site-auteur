<script lang="ts">
	...
	import BibliographyBookCard from "$lib/components/BibliographyBookCard.svelte";
    export let data;
...
<section class="flex flex-col gap-4 mt-24 pb-8 border-b">
    <h2 class="text-5xl font-black text-center mb-4">Bibliographie</h2>
    <h3 class="text-center mb-16">Tous les livres de Katia, classés par année</h3>
    <!-- Timeline -->
    <div class="relative border-l-4 border-accent2 pl-8 space-y-16">
        {#each books as book}
            <div class="relative">
                <!-- Point sur la ligne -->
