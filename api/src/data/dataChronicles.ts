export const chroniclesData = [
  {
    ...
    cover_url: "/images/chronicles/secret-des-secrets.webp",
  ...
  },
  {
    title: "8,2 secondes",
    slug: "8,2-secondes",
    summary: "8,2 secondes. Un parallèle aussi intrigant que la construction de ce livre. Deux histoires, deux femmes que tout oppose.",
    content: `
    ...
    cover_url: "/images/chronicles/8.2.webp",
  ...
  },
  {
    title: "cache-cache",
    slug: "cache-cache",
    summary: "Cache-cache reste un thriller original, sombre et intelligent, qui joue avec nos nerfs et nos certitudes. ",
    content: `
    ...
    cover_url: "/images/chronicles/cache-cache.webp",
    published_at: new Date("2026-01-18"),
    is_active: true
  },
  {
    title: "Le crépuscule de la veuvue blanche",
    slug: "le-crepuscule-de-la-veuve-noire",
    summary: "Genji, youtubeur à succès spécialiste de dossiers criminels, remet à la une l'histoire de la veuve blanche ; une tueuse en série qui sévissait dans les années 2000 et morte il y a dix ans.",
    content: `
    ...
    cover_url: "/images/chronicles/le-crepuscule-de-la-veuve-noire.webp",
